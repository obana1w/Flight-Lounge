  ...
  return (
    <section className="relative pt-10 pb-14 sm:pt-12 sm:pb-16 lg:pt-14 lg:pb-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-full sm:max-w-[640px] lg:max-w-[720px] mx-auto text-center px-2 sm:px-0">
        ...
        >
          <p>
          Плейлисты, уведомления, бесконечный поток звука. А там, над облаками, говорят только когда нужно. Каждая фраза — решение. Мы соединяем живой авиационный эфир с мягким лаунж-звучанием, создавая пространство, где можно работать, думать и просто быть.
          </p>
        </motion.div>
