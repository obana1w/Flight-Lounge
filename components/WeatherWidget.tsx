  ...
  return (
    <AnimatePresence>
      {show && metar && (
        ...
        >
          <div className="rounded-xl border border-border/30 bg-card/50 p-4 backdrop-blur-sm space-y-3">
            {/* Wind Info */}
            {metar.windDir !== undefined && metar.windSpeed !== undefined && (
              <div className="flex items-center justify-center gap-2 rounded-lg bg-background/40 py-2 px-3">
                <Wind className="h-3.5 w-3.5 text-primary/70" strokeWidth={1.5} />
                <span className="text-xs text-muted/60">Ветер:</span>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Cloud className="h-3.5 w-3.5 text-primary/70" strokeWidth={1.5} />
            ...
            <div className="rounded-lg bg-background/60 p-3">
              <pre className="font-mono text-[11px] leading-relaxed text-foreground/90 whitespace-pre-wrap break-words">
                {metar.raw}
              </pre>
            </div>
            ...
            {metar.sunrise && metar.sunset && (
              <div className="flex items-center justify-around pt-1">
                <div className="flex items-center gap-2">
                  <Sunrise className="h-5 w-5 text-warning/70" strokeWidth={1.5} />
                ...
                <div className="flex items-center gap-2">
                  <Sunset className="h-5 w-5 text-warning/70" strokeWidth={1.5} />
                  <div className="text-xs">
