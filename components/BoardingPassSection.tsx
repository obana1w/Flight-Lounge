      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr]">
            {/* Main Section */}
            <div className="p-6 sm:p-7 md:p-8 lg:p-10 flex flex-col gap-5 sm:gap-6 lg:gap-7">
              {/* Header */}
              <div className="flex justify-between items-center">
                ...
                <div className="inline-flex items-center px-2 sm:px-3 py-1 sm:py-1.5 bg-primary/10 border border-primary/20 rounded-md">
                  <span className="text-[9px] sm:text-[10px] font-mono text-primary uppercase tracking-wider leading-none">
                    First Class
                  </span>
                </div>
              </div>
            ...
            {/* Stub Section */}
            <div
              className="border-t-2 lg:border-t-0 lg:border-l-2 border-dashed p-6 sm:p-7 lg:p-10 flex flex-col items-center justify-center gap-3 sm:gap-4 text-center bg-card/30 backdrop-blur-xl"
              style={{
                borderColor: '#1E293B'
              }}
            >
              ...
              <button
                ...
                className="w-full sm:w-auto inline-flex cursor-pointer items-center justify-center gap-2.5 px-6 sm:px-7 py-3 sm:py-[14px] bg-gradient-to-br from-primary to-secondary rounded-[10px] text-[14px] sm:text-[15px] font-semibold text-white transition-all hover:-translate-y-0.5"
                style={{
